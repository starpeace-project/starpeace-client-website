...
window.starpeace.asset.AssetManager = class AssetManager
  ...
  set_planet_metadata: (planet_type, resource) ->
    @client.ui_manager.vue_application.$set(@client.ui_manager.vue_application.asset_manager.planet_type_metadata, planet_type, resource.data)
  ...
  set_map_texture: (map_id, resource) ->
    @client.ui_manager.vue_application.$set(@client.ui_manager.vue_application.asset_manager.map_id_texture, map_id, resource)
  ...
  set_planet_atlas: (planet_type, resource) ->
    unless @planet_type_atlas[planet_type]?
      @client.ui_manager.vue_application.$set(@client.ui_manager.vue_application.asset_manager.planet_type_atlas, planet_type, [])
    @client.ui_manager.vue_application.asset_manager.planet_type_atlas[planet_type].push resource
    @client.notify_assets_changed()
