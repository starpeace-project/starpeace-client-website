...
export default class ConcreteLibrary extends Library {
  ...
  load_concrete_metadata (concreteMetadata: Array<any>): void {
    for (const concrete of concreteMetadata) {
      this.metadata_by_id[concrete.id] = concrete;
