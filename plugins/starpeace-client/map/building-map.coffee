...
export default class BuildingMap
  constructor: (@client_state, @building_manager, @road_manager, @width, @height) ->
    ...
    @building_chunks = new ChunkMap(@width, @height, 30, ((chunk_x, chunk_y) => @building_manager.load_chunk(chunk_x, chunk_y)), (chunk_info, building_ids) =>
    ...
    @road_chunks = new ChunkMap(@width, @height, 30, ((chunk_x, chunk_y) => @road_manager.load_chunk(chunk_x, chunk_y)), (chunk_info, road_data) =>
