...
export default class Logger {
  ...
  static banner (clientVersion: string): void {
    ...
    let version_text = clientVersion;
    ...
    console.debug(`%c[STARPEACE]%c client %c${clientVersion}%c created`, 'font-size:16px;line-height:20px;background-color:#395950;color:#fff', 'background-color:#fff;color:#000;line-height:20px;', 'font-weight:bold;text-decoration:underline', 'font-weight:normal;text-decoration:none');
  }
